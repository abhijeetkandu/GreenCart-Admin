...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .admin-pill {
            background: rgba(78,202,127,0.15);
            color: var(--mint);
            font-size: 0.6rem;
            font-weight: 700;
        ...
        .btn-view-store {
            ...
            color: var(--leaf);
            border: 1px solid rgba(30,92,56,0.15);
            border-radius: 8px;
            padding: 0.5rem 1rem;
            font-size: 0.82rem;
            font-weight: 600;
        ...
        .btn-primary-gc:hover { background: var(--leaf); box-shadow: 0 6px 20px rgba(13,35,24,0.2); transform: translateY(-1px); }
        ...
        .badge-stock-ok  { background: #e6f9ef; color: var(--sage); font-size: 0.75rem; font-weight: 600; padding: 0.2rem 0.6rem; border-radius: 50px; }
        .badge-stock-low { background: #fff8e6; color: #b07d00; font-size: 0.75rem; font-weight: 600; padding: 0.2rem 0.6rem; border-radius: 50px; }
        .badge-stock-out { background: #fff0ec; color: var(--ember); font-size: 0.75rem; font-weight: 600; padding: 0.2rem 0.6rem; border-radius: 50px; }
        ...
        /* ACTION BUTTONS */
        .btn-edit-sm {
            background: #fff8e6; color: #b07d00;
        ...
        .btn-del-sm {
            background: #fff0ec; color: var(--ember);
        ...
        /* LINK ALL ORDERS */
        .link-all {
            font-size: 0.8rem; color: var(--sage); font-weight: 600;
        ...
        .img-upload-grid input[type=file] { font-size: 0.75rem; }
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="#add-product-section" class="nav-item" onclick="scrollToSection('add-product-section')">
...
<div class="main">
    ...
    <div class="page-content">
        ...
        <div class="sc" id="add-product-section" style="animation-delay:0.15s">
            <div class="sc-head">
                <div class="sc-title">➕ Add New Product</div>
            </div>
            <div class="sc-body">
                <form action="<%=request.getContextPath()%>/addProduct" method="post" enctype="multipart/form-data">
                    ...
                    <p class="form-label mb-2">Product Images <small class="text-muted-sm">(upload up to 8)</small></p>
                ...
                <table class="gc-table">
                    ...
                    <%
                        while(prodRs.next()) {
                            ...
                            int imgCnt = 0;
                            if(imgRs.next()) imgCnt = imgRs.getInt(1);
                            imgRs.close(); imgPs.close();

                            String stockBadge = "badge-stock-ok";
                            String stockLabel = "✓ " + pqty + " in stock";
                            if(pqty == 0) { stockBadge = "badge-stock-out"; stockLabel = "✗ Out of stock"; }
                    ...
                    <tr>
                        ...
                        <td><span class="text-muted-sm">🖼 <%= imgCnt %></span></td>
                        <td>
                            ...
                            <form action="<%=request.getContextPath()%>/deleteProduct" method="post" style="display:inline"
                                  onsubmit="return confirm('Delete \'<%= safeName %>\'? This action cannot be undone.')">
