...
<%
    ...
    // Conversion rate = orders / sessions, capped at 100%
    double conversionRate = 0;
    if (totalSessions > 0) {
        conversionRate = (totalOrders * 100.0) / totalSessions;
...
<head>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .si.g{background:#e6f9ef;} .si.o{background:#fff0ec;} .si.b{background:#edf3ff;} .si.y{background:#fffbe6;}
        ...
        /* Conversion chip */
        .conv-chip{display:inline-flex;align-items:center;gap:0.4rem;background:#f0faf5;border:1px solid #b8dfc9;border-radius:8px;padding:0.4rem 1rem;font-size:0.8rem;color:var(--sage);font-weight:600;}
        .conv-chip .note{font-weight:400;color:var(--mist);font-size:0.7rem;}
...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="stats">
            ...
            <div class="sc"><div class="si o">📦</div><div><div class="sv"><%= totalOrders %></div><div class="sl">Total Orders</div></div></div>
        </div>
        ...
        <div class="g2">
            ...
            <div class="card">
                ...
                <div class="cb" style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:160px;gap:0.75rem;text-align:center;">
                    ...
                    <div class="conv-chip">
                        📊 <%= String.format("%.1f", conversionRate) %>% Conversion Rate
                        <span class="note">(orders ÷ sessions)</span>
                    </div>
                </div>
            </div>
        </div>
