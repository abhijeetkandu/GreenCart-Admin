...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .mini-stat .num {
            font-family:'Syne',sans-serif;
            font-size:1.6rem; font-weight:800; color:var(--mint);
        }
        .mini-stat .lbl {
        ...
        .alert-err {
            background:#fff0ed; border:1.5px solid #ffc4b4;
            color:var(--ember); border-radius:12px;
        ...
        .field-icon {
            ...
            width:18px; color:var(--mist); pointer-events:none;
        }
        .field-input {
            width:100%; background:#fff;
            border:1.5px solid #e2ddd8; border-radius:12px;
        ...
        .divider {
            display:flex; align-items:center;
            gap:0.8rem; margin:1.8rem 0 1.2rem;
        }
...
<div class="right-panel">
    <div class="login-card">
        ...
        <div class="divider"><hr><span>Not an admin?</span><hr></div>
        <div class="back-link">
            <%-- ✅ FIXED PATH: was /views/home.jsp → now /views/user/home.jsp --%>
            <a href="<%=request.getContextPath()%>/views/user/home.jsp">← Back to GreenCart Store</a>
        </div>
    </div>
</div>
